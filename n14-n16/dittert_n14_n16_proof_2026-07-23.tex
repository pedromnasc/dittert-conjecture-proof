...
\author{Reproducible working note}
\date{23 July 2026}
...
$\sum_{i\in I}r_i=k+\varepsilon$.  Applying AM--GM inside $I$ and its
complement gives
\[
...
\cite{Minc1984,PulaSongWanless2011}
\begin{equation}\label{eq:Ygeneral}
 ...
 a_1+a_2+mx=1.
\end{equation}
Here $0\le a_i\le1/m$.  Although Minc already resolved this face, the
following short calculation supplies the particular one-variable reduction
needed below and avoids importing any unrecorded formula for the minimizer.
